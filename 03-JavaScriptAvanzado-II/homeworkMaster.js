...
function cacheFunction(cb) {
    ...
    return function(arg) {
        if (cache.hasOwnProperty(arg)) {
            ...
            var result = cb(arg); // calcular el resultado de la ejecución y guardar en variable
            cache[arg] = result; // guardar el resultado en el objeto
...
textoAsteriscos("El texto"); // *El texto*

// PRÓXIMO TATUAJE;:
// EL PRIMER PARAMETRO DEL BIND ES QUIEN ES THIS
